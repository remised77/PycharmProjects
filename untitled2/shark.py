...
class shark:
    ...
    ''' prelimLine = self.moveShark(shark,fish1,fish2,fish3)
        ...
        if prelimLine[0] <= 1.42:
            ...
            self.shark = self.sharkLine(prelimLine[2], prelimLine[3], prelimLine[4])
    ...
    def sharkLine(self,xDist,yDist,sharkCoords):
        ...
        if xDist == 0:
            if yDist < 0:
                practiceShark = Point(sharkCoords.getX() + 0.5, sharkCoords.getY() + 1.5)
            ...
            if xDist < 0:
                practiceShark = Point(sharkCoords.getX() + 1.5, sharkCoords.getY() + 0.5)
